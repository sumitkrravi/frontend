...
const jobsData = {
  buttons: [
    { label: "RBI Officer Apply Online", className: "btn-success", link: "/jobs/1" },
    { label: "Bihar Bed Apply Online", className: "btn-primary", link: "/jobs/2" },
    { label: "Bihar STET Apply Online", className: "btn-warning", link: "/jobs/3" },
    { label: "DSSSB Apply Online", className: "btn-danger", link: "/jobs/4" },
    { label: "SSC CGL Admit Card", className: "btn-info", link: "/jobs/5" },
    { label: "HTET Result", className: "btn-dark", link: "/jobs/6" },
    { label: "MPESB Apply Online", className: "btn-secondary", link: "/jobs/7" },
    { label: "CISF Admit Card", className: "btn-primary", link: "/jobs/8" },
  ],
  ...
  sections: [
    {
      ...
      posts: [
        ...
        { 
          ...
          date: "25 Sep 2025",
          desc: "Online application open for Railway ECR Apprentice.",
